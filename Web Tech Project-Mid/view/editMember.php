...
<body>
    <form method="post" action="../controller/EditDeliverymanCheck.php"
        ...
        <table border="1" cellspacing="0" cellpadding="5" width="100%">
                    ...
                    <fieldset>
                        <form method="POST" action="../controller/editMemberCheck.php">
                            ...
                            <table border="1" cellpadding="10" cellspacing="0">
                                ...
                                <tr>
                                    <td>E-mail: </td>
                                    <td><input type="text" name="useremail" Value="<?php echo $_SESSION['UserEmail'] ?>"
                                            required></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="usergender"
                                            Value="<?php echo $_SESSION['UserGender'] ?>" required>
                                    </td>
                </td>
            </tr>
            ...
            <tr>
                <td>Date Of Birth: </td>
                <td><input type="text" name="udob" Value="<?php echo $_SESSION['UserDateofBirth'] ?>" required></td>
            </tr>

            <tr>
                <td>Phone Number: </td>
                <td><input type="number" name="uphone" Value="<?php echo $_SESSION['UserPhoneNumber'] ?>" required></td>
            </tr>
            <tr>
                <td>NID Number: </td>
                <td><input type="number" name="unid" Value="<?php echo $_SESSION['UserNIDNumber'] ?>" required></td>
            </tr>
            <tr>
                <td>Address:</td>
                <td><input type="text" name="uAdd" Value="<?php echo $_SESSION['UserAdress'] ?>" required></td>
            </tr>
